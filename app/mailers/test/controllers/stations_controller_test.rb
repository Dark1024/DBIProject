...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { address: @station.address, name: @station.name, office_hours: @station.office_hours, phone_number: @station.phone_number }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { address: @station.address, name: @station.name, office_hours: @station.office_hours, phone_number: @station.phone_number }
    assert_redirected_to station_path(assigns(:station))
  end
